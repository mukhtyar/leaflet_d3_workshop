(function(){
  ...
  ********************************************************************************/
  ...
  d3.csv("data/lyme_disease_2001-2014.csv", function(error, _data) {
    ...
    /* For this particular dataset, y values range from 0 to 65 with most being below 1. A linear 
      scale for y axis may not be the most appropriate representation for this dataset. So while we 
      are keeping the x axis steady for all charts, we are not going to do it for y axis. 
      Of course this is just for demonstation purposes. You will need to
      do what's appropriate for your data. */
