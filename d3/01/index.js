(function(){
  ...
  ********************************************************************************/
  ...
  d3.csv("../../../../assets/data/lyme_disease_2001-2014.csv", function(error, data) {
    ...
    xDomain = stateData.map(function(d) { return d.date; });
    yDomain = [0, d3.max(stateData, function(d) { return d.value; })]
